...
SCHEDULER_CONFIG_FIELDS = (
    ...
    "daily_kline_update_hour",
    "daily_kline_update_minute",
    "market_snapshot_hour",
    "market_snapshot_minute",
    "historical_task_weight_budget_per_60s",
    "background_weight_budget_per_60s",
    "history_validation_hour",
    "history_validation_minute",
    "history_validation_lookback_hours",
    ...
    "rebound_60d_hour",
    "rebound_60d_minute",
    "enable_rebound_365d_snapshot",
    "rebound_365d_top_n",
    "rebound_365d_kline_workers",
